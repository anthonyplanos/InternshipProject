        ...
        <div class="relative overflow-hidden">
            ...
            <header class="relative z-10 mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-6 lg:px-10">
                <a href="{{ url('/') }}" class="inline-flex items-center gap-3">
                    ...
                    <span class="text-lg font-bold tracking-tight" style="font-family: 'Space Grotesk', sans-serif;">{{ config('app.name') }}</span>
                </a>
            ...
            <main class="relative z-10 mx-auto grid w-full max-w-7xl items-center gap-12 px-6 pb-14 pt-10 lg:grid-cols-2 lg:px-10 lg:pb-20">
                <section>
                    ...
                    <p class="mt-5 max-w-xl text-base leading-relaxed text-slate-300">
                        {{ config('app.name') }} gives employees a safe internal space to post ideas, ask hard questions, and discuss proposals without social pressure.
                    </p>

                    <div class="mt-8 flex flex-wrap items-center gap-4">
                        <a href="{{ route('register') }}" class="rounded-2xl bg-cyan-300 px-6 py-3 text-sm font-semibold text-slate-900 hover:bg-cyan-200">Register</a>
                        <a href="{{ route('login') }}" class="rounded-2xl border border-white/20 px-6 py-3 text-sm font-medium text-slate-100 hover:bg-white/10">Login</a>
                    </div>
                </section>
