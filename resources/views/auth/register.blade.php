<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="mt-8 space-y-5">
        ...
        <div>
            ...
            <input id="name" class="block w-full rounded-xl border border-slate-700 bg-slate-950/60 px-4 py-3 text-slate-100 placeholder:text-slate-500 focus:border-emerald-300 focus:outline-none focus:ring-2 focus:ring-emerald-300/40" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="nickname" placeholder="IdeaNavigator" />
        ...
        <div>
            ...
            <input id="email" class="block w-full rounded-xl border border-slate-700 bg-slate-950/60 px-4 py-3 text-slate-100 placeholder:text-slate-500 focus:border-emerald-300 focus:outline-none focus:ring-2 focus:ring-emerald-300/40" type="email" name="email" value="{{ old('email') }}" required autocomplete="username" placeholder="name@company.com" />
        ...
        <div>
            ...
            <input id="password" class="block w-full rounded-xl border border-slate-700 bg-slate-950/60 px-4 py-3 text-slate-100 placeholder:text-slate-500 focus:border-emerald-300 focus:outline-none focus:ring-2 focus:ring-emerald-300/40" type="password" name="password" required autocomplete="new-password" placeholder="Create a secure password" />
        ...
        <div>
            ...
            <input id="password_confirmation" class="block w-full rounded-xl border border-slate-700 bg-slate-950/60 px-4 py-3 text-slate-100 placeholder:text-slate-500 focus:border-emerald-300 focus:outline-none focus:ring-2 focus:ring-emerald-300/40" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Repeat your password" />
        ...
        <div class="rounded-2xl border border-slate-700 bg-slate-950/40 p-4">
            <label for="acknowledge_policy" class="inline-flex items-start gap-3 text-sm text-slate-300">
                <input id="acknowledge_policy" name="acknowledge_policy" type="checkbox" value="1" class="mt-1 rounded border-slate-600 bg-slate-900 text-emerald-300 focus:ring-emerald-300" {{ old('acknowledge_policy') ? 'checked' : '' }} required>
        ...
        <div class="space-y-4 pt-2">
            <button type="submit" class="inline-flex w-full items-center justify-center rounded-xl bg-emerald-300 px-4 py-3 text-sm font-semibold text-slate-900 transition hover:bg-emerald-200 focus:outline-none focus:ring-2 focus:ring-emerald-300/70 focus:ring-offset-2 focus:ring-offset-slate-900">
                Create Account
            </button>
