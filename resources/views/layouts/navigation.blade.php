    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="inline-flex items-center gap-3">
                        ...
                        <span class="text-base font-bold tracking-tight text-cyan-100" style="font-family: 'Space Grotesk', sans-serif;">{{ config('app.name') }}</span>
                    </a>
                </div>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center rounded-md p-2 text-slate-400 transition duration-150 ease-in-out hover:bg-white/10 hover:text-slate-200 focus:outline-none focus:bg-white/10 focus:text-slate-200">
